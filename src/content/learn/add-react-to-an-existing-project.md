...
1. [React ఆధారిత ఫ్రేమ్‌వర్క్‌లలో](/learn/creating-a-react-app) ఒకదాన్ని ఉపయోగించి **మీ యాప్‌లోని React భాగాన్ని రూపొందించండి**.
...
మీ యాప్‌లోని React భాగం ఆ ఫ్రేమ్‌వర్క్‌లలో రూపొందించిన [మాడ్యూల్లను వాడుకొని ప్రయోజనం పొందగలదని](/learn/build-a-react-app-from-scratch#consider-using-a-framework) ఇది నిర్ధారిస్తుంది.
